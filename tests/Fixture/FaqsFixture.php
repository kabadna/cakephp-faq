...
class FaqsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'when_write' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => '記述日'],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'open_period_from' => '2021-05-29 18:04:36',
                'open_period_to' => '2021-05-29 18:04:36',
                'faq_category_id' => 1,
                'when_write' => '2021-05-29 18:04:36',
                'sort_seq' => 1,
                'created' => '2021-05-29 18:04:36',
                'modified' => '2021-05-29 18:04:36',
            ],
        ];
        parent::init();
    }
